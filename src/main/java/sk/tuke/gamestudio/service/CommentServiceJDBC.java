...
public class CommentServiceJDBC implements CommentService {
    ...
    public static final String SELECT = "SELECT game, player, comment, date FROM comment WHERE game = ? LIMIT 5";
    public static final String DELETE = "DELETE FROM comment";
    public static final String INSERT = "INSERT INTO comment (game, player, comment, date) VALUES (?, ?, ?, ?)";
    ...
    public void addComment(Comment comment) {
        try (Connection connection = DriverManager.getConnection(URL, USER, PASSWORD);
            ...
            throw new GamestudioException("Problem inserting comments ", exception);
        }
    }
